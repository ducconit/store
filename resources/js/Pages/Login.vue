                                        ...
                                        <div class="login-item">
                                            ...
                                            <form class="login" @submit.prevent="login">
                                                ...
                                                <p class="form-row form-row-wide">
                                                    ...
                                                    <input v-model="formLogin.username" title="username" type="text" class="input-text">
                                                </p>
                                                <p class="form-row form-row-wide">
                                                    <label class="text">Password</label>
                                                    <input v-model="formLogin.password" title="password" type="password" class="input-text">
                                                </p>
